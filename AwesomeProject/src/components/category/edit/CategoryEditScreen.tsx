...
import {ICategoryCreate, ICategoryEdit, ICategoryItem} from "../types";
import {useDispatch} from "react-redux";
import http_common from "../../../http_common";
import {APP_ENV} from "../../../env";
import {EditCategoryAction} from "../CategoryActions";
...
const CategoryEditScreen = () => {
    ...
    useEffect(() => {
        ...
        http_common.get<ICategoryItem>(`/api/categories/${id}`)
            .then(resp => {
                ...
                setPickedImage(APP_ENV.BASE_URL+"/images/"+ resp.data.image);
    ...
    const onSubmit = async (data: any) => {
        try {
            ...
            await EditCategoryAction(dispatch, model);
    ...
    return (
        <ScrollView style={styles.container}>
            ...
            <View style={styles.contentContainer}>
                <Text style={styles.loginText}>Змінити категорію</Text>
                <View style={{}}>
